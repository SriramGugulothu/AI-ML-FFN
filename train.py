...
def parse_arguments():
  ...
  parser.add_argument('-d', '--dataset', type=str, default='fashion_mnist',choices=["mnist", "fashion_mnist"],
                        help='Dataset choice: ["fashion_mnist", "fashion_mnist"]')
  ...
  parser.add_argument('-l', '--loss', type=str, default='entropy',choices=["mse", "entropy"],help='Choice of MSE or cross Entropy')
  
  parser.add_argument('-o', '--optimizer', type=str, default='nadam', choices = ["sgd", "mgd", "ngd", "rmsProp", "adam", "nadam"],help='Choice of optimizer')
  ...
  parser.add_argument('--hidden_size', '-sz', type=int, default=64, help='Number of hidden neurons in a feedforward layer')

  parser.add_argument('--activation', '-a', type=str, default='relu',choices=["identity", "sigmoid", "tanh", "relu"], help='activation functions')
